...
<div>
    ...
    <div class="row">
        ...
        <div class="center mb30">
            <h1 style="color: #CE2222;">Input Registrasi ID & NIK</h1>
        </div>
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title">Input Registrasi ID & NIK</span>
                </div>
                    ...
                    <form class="form-horizontal" role="form" method="POST"
                        ...
                        <div class="form-group">
                            <label for="noKtp" class="col-lg-3 control-label">Nomor
                                Identitas</label>
                            <div class="col-lg-8">
                                <input class="form-control" id="noKtp" name="noKtp" type="text" required>
                            </div>
                        </div>
                        <div class="clearfix p15 ph15 text-center">
                            <a href="{{ route('menu') }}" class="btn mx-auto p8 w100" id="login">Kembali</a>
