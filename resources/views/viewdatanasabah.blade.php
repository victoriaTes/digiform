                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('msgkirimdata') }}" role="form">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos" style="color: black;"><strong>Status Rumah/Tempat Tinggal :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos" style="color: black;"><strong>Penghasilan Bulanan :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong><?php echo $penghasilan; ?></strong>
                                        </div>
                                    </div>
