...
<body class="sb-l-c sb-l-m sb-r-c" data-target="#nav-spy" data-offset="200">
                ...
                <div class="row">
                    ...
                    <div class="col-8 col-sm-9 col-md-7 col-lg-12 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <h1 style="color: #CE2222;">Frekuensi Transaksi (Per-bulan)</h1>
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('viewdatanasabih') }}" role="form">
                                    @csrf
                                    ...
                                    <div class="section mb-3">
                                        <label for="setorantunai"style="color: black;"><strong>Setoran Tunai : </strong></label>
                                        <select id="setorantunai" name="setorantunai" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Setoran Tunai ---
                                            </option>
                                            @if ($setoran_tunai)
                                            <option value="<?php echo $setoran_tunai; ?>" hidden selected><?php echo $setoran_tunai; ?></option>
                                            @endif
                                            @foreach($FREKUENSI as $dt)
                                    ...
                                    @csrf
                                    <div class="section mb-3">
                                        <label for="penukarantunai"style="color: black;"><strong>Penarikan Tunai :</strong></label>
                                        <select id="penukarantunai" name="penukarantunai" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Penarikan Tunai ---
                                            </option>
                                            @if ($penarikan_tunai)
                                            <option value="<?php echo $penarikan_tunai; ?>" hidden selected><?php echo $penarikan_tunai; ?></option> 
                                            @endif
                                            @foreach($FREKUENSI as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                    ...
                                    <div class="section mb-3">
                                        <label for="setorannontunai"style="color: black;"><strong>Setoran non Tunai :</strong></label>
                                        <select id="setorannontunai" name="setorannontunai" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Setoran non Tunai ---
                                            </option>
                                            @if ($setoran_nontunai)
                                            <option value="<?php echo $setoran_nontunai; ?>" hidden selected><?php echo $setoran_nontunai; ?></option> 
                                            @endif
                                            @foreach($FREKUENSI as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                    ...
                                    <div class="section mb-3">
                                        <label for="penarikannontunai"style="color: black;"><strong>Penarikan non Tunai :</strong></label>
                                        <select id="penarikannontunai" name="penarikannontunai" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Penarikan non Tunai ---
                                            </option>
                                            @if ($penarikan_nontunai)
                                            <option value="<?php echo $penarikan_nontunai; ?>" hidden selected><?php echo $penarikan_nontunai; ?></option>
                                            @endif
                                            @foreach($FREKUENSI as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
    ...
    <script>
        function removeRequired() {
            var setorantunai = document.getElementById("setorantunai");
            var penukarantunai = document.getElementById("penukarantunai");
            var setorannontunai = document.getElementById("setorannontunai");
            var penarikannontunai = document.getElementById("penarikannontunai");
            
            setorantunai.required = false; // Menghapus atribut required
            penukarantunai.required = false;
            setorannontunai.required = false;
            penarikannontunai.required = false;
        }
        ...
        function addRequired() {
            ...
            setorantunai.required = true; // Menetapkan kembali atribut required
            penukarantunai.required = true;
            setorannontunai.required = true;
            penarikannontunai.required = true;
        }
    </script>
</body>
