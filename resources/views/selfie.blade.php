            ...
            <section id="content" class="p40" style="font-size: 15px;">
                    ...
                    <div class="col-xs-12 col-sm-8 pl30  center-block">
                        <div class="tray-bin pl10 mb10" style="min-height: 250px;">
                            <h5 class="text-muted mt10 fw600 pl10"><i
                                    class="fa fa-exclamation-circle text-danger fa-lg pr10"></i> Unggah KTP </h5>
                ...
                <div class="section" style="display:none;">
                    <div class="col-xs-12 col-sm-8 pl30  center-block">
                        <div class="tray-bin pl10 mb10" style="min-height: 250px;">
                            <h5 class="text-muted mt10 fw600 pl10"><i
                                    class="fa fa-exclamation-circle text-info fa-lg pr10"></i> Unggah Foto Diri </h5>
                            <form action="/file-upload" class="dropzone dropzone-sm" id="dropZone">
                                <div class="fallback">
                                    <input name="file" type="file" multiple />
                                </div>
                ...
                <div class="clearfix p15 ph15 text-center">
                    <button type="submit" class="button mx-auto p8 w100" id="login"><a href="{{ route('kirim') }}" >
                        Simpan</a></button>
                </div>
                <!-- end section -->
            </section>
                ...
                setTimeout(function() {
                    $('.example-preview').each(function(i, e) {
                        ...
                        var thumbOut = setTimeout(function() {
                            Drop.append(This);
                            This.addClass('animated fadeInRight').removeClass(
                                'hidden');
                        }, i * 135);
