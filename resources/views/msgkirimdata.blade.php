                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <h3><strong>Data Anda Sudah Terkirim, Berikut Reg Id Anda :  , Silahkan Datang Ke Cabang Yang Terdekat, Untuk Membuat Rekening Anda.</strong></h3>
                            </div>
                        </div>

                        <div class="clearfix p15 ph15 text-center">
                            <a href="{{ route('index') }}" class="btn mx-auto p8 w100 mr20" id="login" >
                                Kembali</a>
                        </div>
                    </div>
                </div>
