...
<body class="sb-l-c sb-l-m sb-r-c" data-target="#nav-spy" data-offset="200">
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('frekuensitransaksa') }}" role="form">
                                    @csrf
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="transaksisetorantunai" name="transaksisetorantunai" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Transaksi Setoran Tunai ---
                                            </option>
                                            @if ($trx_str_tunai)
                                            <option value="<?php echo $trx_str_tunai; ?>" hidden selected><?php echo $trx_str_tunai; ?></option>
                                            @endif
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="transaksipenukarantunai" name="transaksipenukarantunai" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Transaksi Penarikan Tunai ---
                                            </option>
                                            @if ($trx_pnrkn_tunai)
                                            <option value="<?php echo $trx_pnrkn_tunai; ?>" hidden selected><?php echo $trx_pnrkn_tunai; ?></option>
                                            @endif
                                            @foreach($PENDAPATA as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="transaksisetorannontunai" name="transaksisetorannontunai" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Transaksi Setoran non Tunai ---
                                            </option>
                                            @if ($trx_str_nontunai)
                                            <option value="<?php echo $trx_str_nontunai; ?>" hidden selected><?php echo $trx_str_nontunai; ?></option>
                                            @endif
                                            @foreach($PENDAPATA as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="transaksipenarikannontunai" name="transaksipenarikannontunai" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Transaksi Penarikan non Tunai ---
                                            </option>
                                            @if ($trx_pnrkn_nontunai)
                                            <option value="<?php echo $trx_pnrkn_nontunai; ?>" hidden selected><?php echo $trx_pnrkn_nontunai; ?></option>
                                            @endif
                                            @foreach($PENDAPATA as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
    ...
    <script>
        function removeRequired() {
            var transaksisetorantunai = document.getElementById("transaksisetorantunai");
            var transaksisetorannontunai = document.getElementById("transaksisetorannontunai");
            var transaksipenukarantunai = document.getElementById("transaksipenukarantunai");
            var transaksipenarikannontunai = document.getElementById("transaksipenarikannontunai");
            
            transaksisetorantunai.required = false; // Menghapus atribut required
            transaksipenukarantunai.required = false;
            transaksisetorannontunai.required = false;
            transaksipenarikannontunai.required = false;
        }
        ...
        function addRequired() {
            ...
            transaksisetorantunai.required = true; // Menetapkan kembali atribut required
            transaksipenukarantunai.required = true;
            transaksisetorannontunai.required = true;
            transaksipenarikannontunai.required = true;
        }
    </script>
</body>
