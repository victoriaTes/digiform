                        ...
                        <div class="col-md-10">
                            <div class="panel br-t bw5 br-danger mn">
                                ...
                                <div class="panel-body pn">
                                    <div class="p25 br-b">
                                        <h1 class="fw200 mb10 mt10 text-center"><strong>Data Anda Sudah Terkirim, Berikut Reg Id Anda :</i> <?php echo $regid; ?> </i>, Silahkan Datang Ke Cabang Yang Terdekat, Untuk Membuat Rekening Anda.</strong></h1>
                                    </div>
                                    <div class="clearfix p15 ph15 text-center">
                                    <a href="{{ route('home') }}" class="btn mx-auto p8 w100 mr20" id="login" ><button type="button" class="btn btn-light">
                                            Kembali</button></a>
                                    </div>
                                    <div>
                                        <center>
