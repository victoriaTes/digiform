        ...
        <tr>
            <td>
                <div class="col-md-12">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td width="3%" align="left" style="vertical-align: bottom;font-size:10px;">RT/RW</td>
                            <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            <td width="19%" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->rtrw_ktp }}</td>
                            {{-- <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="32%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kelurahan_ktp }}</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="13%" align="left" style="vertical-align: bottom;font-size:10px;">Kecamatan</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="32%" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kecamatan_ktp }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="6%" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;"></td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="9%" align="left" style="vertical-align: bottom;font-size:10px;">Negara</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="18%" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">INDONESIA</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="32%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kabupaten_ktp }}</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        <td width="17%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Kelurahan/Desa</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="32%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kelurahan }}</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="13%" align="left" style="vertical-align: bottom;font-size:10px;">Kecamatan</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="32%" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kecamatan }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        <td width="17%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Kabupaten/Kota</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="32%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kabupaten }}</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="13%" align="left" style="vertical-align: bottom;font-size:10px;">Propinsi</td>
                    ...
                    <table width="100%">
                        <tr>
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        <td width="12%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Kode Pos</td>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="48%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->agama }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="49%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->email }}</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="8%" align="left" style="vertical-align: bottom;font-size:10px;">NPWP</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="33%" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->nik }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table width="100%">
                        <tr>
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        <td width="17%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Kelurahan/Desa</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="32%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kelurahan_perusahaan }}</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="13%" align="left" style="vertical-align: bottom;font-size:10px;">Kecamatan</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="32%" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kecamatan_perusahaan }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        <td width="20%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Bidang Usaha</td>
                                        <td width="80%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->bidang_usaha }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        <td width="17%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Kabupaten/Kota</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="32%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kabupaten_perusahaan }}</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="13%" align="left" style="vertical-align: bottom;font-size:10px;">Propinsi</td>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="66%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->jabatan }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="8%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Tahun</td>
                ...
                <div class="col-md-12">
                    <table width="100%">
                        <tr>
                            <td width="15%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Penghasilan Bulanan</td>
                            <td width="85%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->penghasilan }}</td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-12">
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="40%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Tujuan Pembukaan Rekening</td>
                                        <td width="60%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->tujuan_rek }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="60%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->tujuan_dana }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="78%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->produk }}</td>
                                        {{-- <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="80%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->sumber_dana }}</td>
                                        {{-- <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="40%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Tujuan Penggunaan Dana</td>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="9%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->setoran_nontunai }}</td>
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="40%" height="20" align="left" style="vertical-align: bottom;font-size:10px;">Frekuensi Penarikan Non Tunai</td>
                                        <td width="9%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->penarikan_nontunai }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="2%" align="left" style="vertical-align: bottom;font-size:10px;">&nbsp;</td>
                                        <td width="8%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->kode_ao }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td width="49%">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="22%" height="20" align="left" style="vertical-align: bottom;font-size:10px;border-bottom: 0.5pt solid black;">{{ $nasabah->riskProfile }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
