...
<script type="text/javascript">
    function Validate() {
        ...
        if (size > maxSize) {
            ...
            alert("Maaf Foto Yang Di Upload Terlalu Besar, Max file size " + maxSizeKB + " KB ");
            file.value = "";
            return false;
        }
    }
                    ...
                    <div class="col-md-12" >
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="post" action="{{ route('konfirmasah') }}" role="form" >
                                 
                                    @csrf
                                    <div class="section mb-3" style='display:none;'>
                                        <label for="regid"style="color: black;"><strong>Reg ID : </strong></label>
                                        <input type="text" id="regid" name="regid" class="form-control" placeholder="Nomor Identitas" value="<?= $regidd; ?>" required />
                                    </div>
                                    ...
                                    <table class="center">
                                        <tr>
                                            <td height: 70px;>
                                                <!-- <img class="responsive" id="gambar" src="#" alt="Pilih Gambar" width="300" height="100" style="display:none;" OnError=" $(this).hide();"/> -->
                                                <img class="responsive" id="gambar" src="<?php echo url('storage/gambarktp/'.$namagambaran);?>"  width="300" height="100" />
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- </div> -->
                                    ...
                                    <div class="clearfix p15 ph15 text-center" >
                                        <!-- <a href="" style="display:none;" class="btn mx-auto p8 w100 mr20" id="login" >
                                            Lanjut</a> -->
                                        
                                        <input type="submit"class="btn mx-auto p8 w100" id="login" value="Next">
                                    </div>
                                </form>
