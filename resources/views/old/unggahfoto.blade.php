                ...
                <div class="row">
                    ...
                    <div class="col-8 col-sm-9 col-md-7 col-lg-12 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <h1 style="color: #CE2222;">Unggah KTP</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12" >
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="post" action="{{ route('konfirmasa') }}" role="form" onclick="return Validate()" enctype="multipart/form-data">
