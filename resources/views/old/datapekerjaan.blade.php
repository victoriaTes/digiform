                                    ...
                                    <div class="section">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>&nbsp;&nbsp;</td>
                                                <td><input type="text" name="teleponperusahaan" id="teleponperusahaan" class="form-control required" size="200" value="<?php echo $telpon_perusahaan; ?>" placeholder="Telepon" maxlength="15" required /></td>
                                            <tr>
                                        </table>
                                        <!-- <br/>
                                        <div class="col-md-2" >
