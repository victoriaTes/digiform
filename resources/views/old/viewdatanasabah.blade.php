                ...
                <div class="row">
                    ...
                    <div class="col-8 col-sm-9 col-md-7 col-lg-12 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">                           
                            ...
                            <h1 style="color: #CE2222;">REVIEW DATA NASABAH</h1>
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('msgkirimdata') }}" role="form">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="alamat"style="color: black;"><strong><h3><u>Alamat Sesuai KTP</u></h3></strong></label>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="alamat"style="color: black;"><strong><h3><u>Alamat Saat Ini</u></h3></strong></label>
                                    </div>

                                    <div class="p25 br-b">
                                        
                                            <div class ="col-md-4" style="text-align: left;">
                                                <label for="address1"style="color: black;"><strong>Alamat :</strong></label>
                                            </div>
                                            <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="address1"style="color: black;"><strong>No. Rumah/Apartemen :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos"style="color: black;"><strong>Punya Istri :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos"style="color: black;"><strong>Punya Anak :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos" style="color: black;"><strong>Lama Kerja (tahun) :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos" style="color: black;"><strong>Jumlah Karyawan :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos" style="color: black;"><strong>Jika Karyawan Penghasilan Utama (Kotor Per-Bulan dalam Rupiah) :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos" style="color: black;"><strong>Penghasilan Tambahan (Per-Bulan dalam Rupiah) : </strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong><?php echo $dana_tambahan; ?></strong>
                                        </div>
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos" style="color: black;"><strong>Jika Wiraswasta, Omzet (Per-Bulan dalam Rupiah): </strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong><?php echo $dana_tambahan; ?></strong>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="alamat"style="color: black;"><strong><h3><u>Estimasi Perkiraan</u></h3></strong></label>
                                    </div>

                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos" style="color: black;"><strong>Transaksi Setoran Tunai :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos"style="color: black;"><strong>Transaksi Penarikan Tunai :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos"style="color: black;"><strong>Transaksi Setoran Non Tunai :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos"style="color: black;"><strong>Transaksi Penarikan Non Tunai :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="mb-3">
                                        <label for="alamat"style="color: black;"><strong><h3><u>Frekuensi transaksi</u></h3></strong></label>
                                    </div>

                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos" style="color: black;"><strong>Setoran Tunai :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos"style="color: black;"><strong>Penarikan Tunai :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos"style="color: black;"><strong>Setoran Non Tunai :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="p25 br-b">
                                        <div class ="col-md-4" style="text-align: left;">
                                            <label for="kodepos"style="color: black;"><strong>Penarikan Non Tunai :</strong></label>
                                        </div>
                                        <div class ="col-md-8" style="text-align: left;">
                                    ...
                                    <div class="clearfix p15 ph15 text-center">
                                        <a href="{{ route('datakeuangan') }}" class="btn mx-auto p8 w100 mr20" id="login" style="display:none;" >
                                            Kembali</a>
                                        <button class="btn btn-primary btn-lg ml10" type="submit" name="login" value="Kembali" id="btnlogin">Kembali</button>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <button class="btn btn-danger btn-lg mr10 " type="submit" name="login" value="Kirim" id="login">Kirim</button>
