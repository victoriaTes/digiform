                                            ...
                                            <div class="table-wrapper-scroll-y my-custom-scrollbar">
                                                ...
                                                <form class="form-horizontal" method="post" action="{{ route('unggahfoto') }}" role="form">
                                                    ...
                                                    <div class="section mb-3" style='display:none;'>
                                                        ...
                                                        <input type="text" id="regid" name="regid" class="form-control" placeholder="Nomor Identitas" value="<?php echo $regid; ?>" required />
                                                    </div>
                                                    <table>
                                                        <!-- <tr>
                                                            <td width="5%"></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="3%" valign="top">2. </td>
                                                            <td width="85%" style="text-align: justify;">
                                                                Pemegang Rekening rnenyatakan bahwa dana yang disetorkan/dipergunakan/diransaksikan di PT. Bank Victoria lnternational Tbk, tidak berasal dari/untuk tujuan tindak pidana pencucian uang (money laundering) ditransaksikan di PT. Bank Victoria lnternational Tbk, tidak berasal dari/untuk tujuan tindak pidana pencucian uang (money laundering) sebagaimana dimaksud dalam UU. 8 tahun 2010 tentang Pencegahan dan Pemberantasan Tindak Pidana Pencucian        Uang berikut perubahan-perubahannya. Apabila ada indikasi pencucian uang tersebut, maka Bank berhak menolak memproses transaksi dan menindaklanjuti serta memblokir dana tersebut tanpa atau atas permintaan pejabat/instansi yang berwenang.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="85%" style="text-align: justify;">
                                                                Bank diberi persetujuan dan kuasa dari Pemegang Rekening untuk memberi keterangan, informasi atau data Pemegang Rekening, memblokir, menyerahkan atau mendebet, atas permintaan  instansi  yang berwenang atau pihak lain guna memenuhi ketentuan hokum yang berlaku dengan pemberitahuan kepada Nasabah atau Pemegang Rekening.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="85%" style="text-align: justify;">
                                                                Pengakhiran syarat-syarat dan ketentuan umum ini mengesampingkan pasal 1266 & 1267 KHUPerdata yaitu sepanjang menyangkut diperlukannya putusan pengadilan untuk mengakhiri syarat-syarat dan ketentuan umum ini.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td width="85%" style="text-align: justify;">
                                                                Apabila di kemudian hari diketahui bahwa dokumen yang diberikan kepada Bank adalah palsu atau tidak benar antara lain dan tidak terbatas pada KTP, NPWP, Akta Pendirian Perusahaan, Domisili, SIUP, TDP serta tidak sesuai dengan ketentuan Penerapan Program Anti Pencucian Uang dan Pencegahan Pendanaan Terorisme (APU FPT) serta rekeningnya diduga digunakan untuk transaksi penipuan dan/atau menampung hasil kejahatan maka Bank diberi kuasa untuk memblokir/menutup rekening.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td width="85%" style="text-align: justify;">
                                                                Dalam hal ditetapkan Kebijakan Bank untuk merubah status kantor atau menutup atau memindahkan Kantor Bank dimana rekening tercatat, maka Bank akan memindahkan pencatatan rekening tersebut pada kantor yang ditunjuk Bank dengan pemberitahuan kepada Nasabah atau Pemegang Rekening.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="85%" style="text-align: justify;">
                                                                Perubahan nama, kedudukan, alamat atau perubahan-perubahan lain yang terjadi pada Pemilik Rekening hanus diberitahukan pada Bank secara tertulis. Dalam hal-hal demikian Bank tidak akan menanggung kerugian apapun juga akibat kelalaian Pemilik Rekening untuk memberitahukan kejadian-kejadian itu.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="3%" valign="top">11. </td>
                                                            <td width="85%" style="text-align: justify;">
                                                                Bank berhak untuk menetapkan dan merubah tingkat bunga, cara menghitung bunga dan biaya-biaya lainnya sehubungan dengan rekening ini. Bank setiap bulan akan menginimkan salinan rekerning tetapi berhak untuk tidak menginimkannya jika Bank menganggap perlu.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="3%" valign="top">12. </td>
                                                            <td width="85%" style="text-align: justify;">
                                                                Bila diketahui terdapat keterangan alau identitas palsu darn Pemiik Rekening maka Bank berhak dan diberi kuasa untuk melakukan tindakan yang dianggap perlu.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="3%" valign="top">4. </td>
                                                            <td width="85%" style="text-align: justify;">
                                                                Deposito dapat diperpanjang secara otomatis sesuai permintaan Nasabah dengan tingkat suku bunga yang berlaku pada saat perpanjangan.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="3%" valign="top">7. </td>
                                                            <td width="85%" style="text-align: justify;">
                                                                Bea Materai yang timbul pada saat penerbitan maupun secara pencairan Deposito menjadi beban Nasabah
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="3%" valign="top">9. </td>
                                                            <td width="85%" style="text-align: justify;">
                                                                Insentif yang diterima oleh Nasabah akan dipersamakan dengan biaya bunga, sehingga apabila yang diterima oleh Nasabah melebihi dari suku bunga yang ditetapkan LPS, maka akan mengikuti ketentuan yang ditetapkan oleh LPS.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="3%" valign="top">1. </td>
                                                            <td width="85%" style="text-align: justify;">
                                                                Pada saat pencairan deposito Nasabah harus mengembalikan Bilyet Deposito asli ke Bank dan ditandatangani pada kolom yang sudah disediakan pada halaman belakang Bilyet Deposito asli.
                                                            </td>
                                                            <td width="5%"></td>
                                                        </tr>
