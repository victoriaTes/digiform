...
<head>
    ...
    <style>
        ...
        body {
            height: 100%;
            /* Make the entire viewport height */
            margin: 0;
            /* Remove default margins */
        }

        #hero {
            /* Adjust the element that should take up the fullscreen height */
    ...
    <header id="hero">
        <div class="container">
            <div class="intro-text">
                ...
                <div class="intro-lead-in">Selamat Datang di <b class="text-danger">Bank Victoria International</b>
                </div>
                ...
                <a href="{{ route('ceknik') }}" class="page-scroll btn btn-xl mt10 btn-danger">Buka Rekening
                    Baru</a>
        ...
        <div class="container mw850">
            <div class="row">
                <div class="col-md-6 text-left">
                    <span class="copyright text-muted" style="color: white">Copyright &copy; <b>Bank Victoria International</b> 2024</span>
                </div>
