...
<body class="sb-l-c sb-l-m sb-r-c" data-target="#nav-spy" data-offset="200">
                ...
                <div class="row">
                    ...
                    <div class="col-8 col-sm-9 col-md-7 col-lg-12 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <h1 style="color: #CE2222;">Data Keuangan</h1>
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('estimasiperkirain') }}" role="form">
                                    @csrf
                                    ...
                                    <div class="section mb-3">
                                        <label for="penghasilan"style="color: black;"><strong>Penghasilan Bulanan :</strong></label>
                                        <select id="penghasilan" name="penghasilan" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Penghasilan ---
                                            </option>
                                            @if ($penghasilan)
                                            <option value="<?php echo $penghasilan; ?>" hidden selected><?php echo $penghasilan; ?></option>
                                            @endif
                                            @foreach($PENDAPATA as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <br/>
                                    ...
                                    <!-- <div class="section mb-3">
                                        <label for="penghasilantambahan"style="color: black;"><strong>Penghasilan Tambahan (Per-Bulan dalam Rupiah) : </strong></label>
                                        <select id="penghasilantambahan" name="penghasilantambahan" class="form-control form-control-lg required" required>
                                            <option value="<//?php echo $dana_tambahan; ?>" selected><//?php echo $dana_tambahan; ?></option>
                                            @foreach($PENDAPATA as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="section mb-3">
                                        <label for="omzet_karyawan"style="color: black;"><strong>Jika Wiraswasta, Omzet (Per-Bulan dalam Rupiah): </strong></label>
                                        <select id="omzet_karyawan" name="omzet_karyawan" class="form-control form-control-lg required" required>
                                            <option value="<//?php echo $omzet_karyawan; ?>" selected><//?php echo $omzet_karyawan; ?></option>
                                            @foreach($PENDAPATA as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="pembukanrekening" name="pembukanrekening" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Tujuan Pembukaan Rekening ---
                                            </option>
                                            @if ($tujuan_rek)
                                            <option value="<?php echo $tujuan_rek; ?>" hidden selected><?php echo $tujuan_rek; ?></option>
                                            @endif
                                            @foreach($SUMBERDAN as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="sumberdana" name="sumberdana" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Sumber Dana ---
                                            </option>
                                            @if ($sumber_dana)
                                            <option value="<?php echo $sumber_dana; ?>" hidden selected><?php echo $sumber_dana; ?></option>
                                            @endif                                            
                                            @foreach($SUMBERPENGHASILA as $SUMBERPENGHASIL)
                                                <option value="{{$SUMBERPENGHASIL->keterangan}}">{{$SUMBERPENGHASIL->keterangan}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="pengguanaandana" name="pengguanaandana" class="form-control form-control-lg required" required>
                                            <option value="" selected disabled hidden>--- Pilih Tujuan Penggunan Dana ---
                                            </option>
                                            @if ($tujuan_dana)
                                            <option value="<?php echo $tujuan_dana; ?>" hidden selected><?php echo $tujuan_dana; ?></option>
                                            @endif                                            
                                            @foreach($SUMBERDAN as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                    ...
                                    <div class="clearfix p15 ph15 text-center">
                                        <a href="{{ route('datapekerjaan') }}" class="btn mx-auto p8 w100 mr20" id="login" style="display:none;" >
                                            Kembali</a>
                                        <button onclick="removeRequired()" class="btn btn-primary btn-lg ml10" type="submit" name="login" value="Kembali" id="btnlogin">Kembali</button>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <script>
        function removeRequired() {
            //var penghasilantambahan = document.getElementById("penghasilantambahan");
            var pembukanrekening = document.getElementById("pembukanrekening");
            var sumberdana = document.getElementById("sumberdana");
            var pengguanaandana = document.getElementById("pengguanaandana");
            var penghasilan = document.getElementById("penghasilan");
            //var omzet_karyawan = document.getElementById("omzet_karyawan");
            
            //penghasilantambahan.required = false; // Menghapus atribut required
            pembukanrekening.required = false;
            sumberdana.required = false;
            pengguanaandana.required = false;
            penghasilan.required = false;
            //omzet_karyawan.required = false;
        }
        ...
        function addRequired() {
            ...
            //penghasilantambahan.required = true; // Menetapkan kembali atribut required
            pembukanrekening.required = true;
            sumberdana.required = true;
            pengguanaandana.required = true;
            penghasilan.required = true;
            //omzet_karyawan.required = true;
        }
    </script>
</body>
