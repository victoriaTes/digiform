                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('datakeuangin') }}" role="form">
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <input type="text" id="namaperusahaan" name="namaperusahaan" class="form-control required" value="<?php echo $nama_perusahaan; ?>" placeholder="Nama Perusahaan" required="false" />
                                    </div>
                                    <br/>
                                    @csrf
                                    <div class="section mb-3">
                                        <label for="alamatPerusahaan"style="color: black;"><strong>Alamat Perusahaan</strong></label>    
                                        <input type="text" id="alamatPerusahaan" name="alamatPerusahaan" class="form-control required" value="<?php echo $alamat_perusahaan; ?>" placeholder="Alamat Perusahaan" required="true" />                   
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <input type="text" id="rtperusahaan" name="rtperusahaan" class="form-control required" value="<?php echo $rt_perusahaan; ?>" placeholder="RT" required />                   
                                    </div>
                                    <br/>

                                    <div class="section mb-3">
                                        <label for="rwperusahaan"style="color: black;"><strong>RW :</strong></label>    
                                        <input type="text" id="rwperusahaan" name="rwperusahaan" class="form-control required" value="<?php echo $rw_perusahaan; ?>" placeholder="RW" required />                   
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section">
                                        ...
                                        <table>
                                            <tr>
                                                <td><input type="text" name="teleponareaperusahaan" size="50" id="teleponareaperusahaan" class="form-control required" value="<?php echo $artlpprs; ?>" placeholder="Kode Telepon" required /></td>
                                                <td>&nbsp;&nbsp;</td>
                                                <td><input type="text" name="teleponperusahaan" id="teleponperusahaan" class="form-control required" size="200" maxlength="9" value="<?php echo $telpon_perusahaan; ?>" placeholder="Telepon" maxlength="15" required /></td>
                                            <tr>
                                        </table>
                                        <!-- <br/>
                                        <div class="col-md-2" >
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="jobPositionCode" name="jobPositionCode" class="form-control form-control-lg required" required>
                                            <option value="<?php echo $kd_pekerjaan; ?>"><?php echo $pekerjaan; ?></option>        
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <!-- <option value="<//?php echo $kdoccupation; ?>"><//?php echo $occupation; ?></option> -->
                                            <option value="<?php echo $kd_usaha; ?>" selected><?php echo $bidang_usaha; ?></option>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <input type="number" id="lama_kerja" name="lama_kerja" class="form-control required" value="<?php echo $lama_kerja; ?>" placeholder="Lama Kerja" required/>                   
                                    </div>
                                    <br/>

                                    <div class="section mb-3">
                                        <label for="jumlah_karyawan"style="color: black;"><strong>Jumlah Karyawan :</strong></label>
                                        <select id="jumlah_karyawan" name="jumlah_karyawan" class="form-control form-control-lg required" required>
                                            <option value="<?php echo $jumlah_karyawan; ?>"><?php echo $jumlah_karyawan; ?></option>        
