...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{!! asset('admindesigns/assets/admin-tools/admin-forms/css/admin-forms.css') !!}">
...
<body class="sb-l-c sb-l-m sb-r-c" data-target="#nav-spy" data-offset="200">
    <div class="animated fadeIn" id="main">
        ...
        <section id="content_wrapper" class="mt50">
            ...
            <!-- Begin: Content -->
            <section id="content" class="center p40" style="font-size: 15px;">
                ...
                <div class="admin-form theme-info">
                    <div class="panel-body bg-light p50" style="border-radius: 10px;">
                        ...
                        <div class="row">
                            {{-- <div class="col-md-6">
                                <div class="clearfix p10 ph15 text-center bg-light">
                                    <a href="{{ route('nonocr') }}" class="button" id="menu">
                            ...
                            <div class="col-md-12">
                                <div class="clearfix p10 ph15 text-center bg-light">
                                    <a href="{{ route('registrasi') }}" class="button" id="menu">
                        ...
                        {{-- <div class="row">
                            <div class="col-md-6">
                                <div class="clearfix p10 ph15 text-center bg-light">
                                    <a href="{{ route('openaccount') }}" class="button" id="menu">
                            ...
                            <div class="col-md-6">
                                <div class="clearfix p10 ph15 text-center bg-light">
                                    <button type="submit" class="button" id="menu">
                                        <img src="{{ URL::to('/assets/images/logo/ibmb.png') }}" alt="avatar"> <br>
                                        Aktivasi IBMB</button>
                                </div>
                            </div>
                        </div> --}}
    ...
    <script type="text/javascript" src="{!! asset('admindesigns/vendor/jquery/jquery_ui/jquery-ui.min.js') !!}">
    </script>
    ...
    <script type="text/javascript"
        src="{!! asset('admindesigns/assets/admin-tools/admin-forms/js/advanced/steps/jquery.steps.js') !!}"></script>
    <script type="text/javascript"
        src="{!! asset('admindesigns/assets/admin-tools/admin-forms/js/jquery.validate.min.js') !!}"></script>
