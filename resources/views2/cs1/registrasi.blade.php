                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form">
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Registrasi ID</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">NIK</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text">
                                        </div>
                                    </div>
                                    <div class="clearfix p15 ph15 text-center">
                                        {{-- <a class="btn mx-auto p8 w100 mr20" id="login" href="{{ route('selfie') }}" >
                                            Proses</a> --}}
