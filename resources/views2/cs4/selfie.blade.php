        ...
        <div class="col-xs-12 col-sm-8 pl30  center-block">
            <div class="tray-bin pl10 mb10" style="min-height: 250px;">
                ...
                <form class="dropzone dropzone-sm" id="dropZone" role="form" method="POST"
                    ...
                    action="{{ route('selfie.detail.post', ['reg_id' => $nasabah->reg_id]) }}">
                    @csrf
            ...
            Dropzone.options.dropZone = {
                ...
                init: function() {
                    ...
                    this.on("queuecomplete", function() {
                        ...
                        if (file && file.size > 2 * 1024 * 1024) { // file size is in bytes
                            // If file size is greater than 2MB, reload the page
                            location.reload();
                        } else {
                            window.location.href =
                                "{{ route('kirim.detail', ['reg_id' => $nasabah->reg_id]) }}";
                        }
                    });
