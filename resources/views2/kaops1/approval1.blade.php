                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form">
                                    ...
                                    {{-- <div class="clearfix p15 ph15 text-center">
                                        <button type="submit" class="btn btn-success btn-lg mx-auto p8 w100 mr20" id="login"
                                            onclick="approve()">
                                                Setuju</button>
                                        <button type="submit" class="btn btn-danger btn-lg mx-auto p8 w100 mr20" id="login"
                                            onclick="reject()"><a href="{{ route('kaops') }}">
                                                Tolak</a></button>
                                    </div> --}}

                                    <div class="clearfix p15 ph15 text-center">
                                        <button type="submit" class="btn btn-success btn-lg mx-auto p8 w100 mr20"
                                            id="login" onclick="approve()">
                                            <a href="{{ route('kaops') }}">
                                                Setuju</a></button>
                                        <button type="submit" class="btn btn-danger btn-lg mx-auto p8 w100 mr20"
                                            id="login" onclick="reject()"><a href="{{ route('kaops') }}">
                                                Tolak</a></button>
                                    </div>
                                </form>
                            </div>
