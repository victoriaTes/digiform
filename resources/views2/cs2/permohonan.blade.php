...
<head>
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" type="text/css" href="{!! asset('admindesigns/vendor/plugins/magnific/magnific-popup.css') !!}">
...
<body class="sb-l-c sb-l-m sb-r-c" data-target="#nav-spy" data-offset="200">
    <div id="main" class="animated fadeIn">
        ...
        <section id="content_wrapper" class="mt50">
            ...
            <div id="my-popup" class="popup-basic admin-form mfp-with-anim mfp-hide popup-content">
                <div class="panel-heading">
                    <span class="panel-title" style="color: #CE2222;"></i>Konfirmasi Setoran Tunai</span>
                </div>
                {{-- <form method="post" action="/" id="comment"> --}}
                <form>
                    <div class="panel-body p25">
                        <div class="section row">
                            <h3>Apakah anda yakin ingin setor tunai?</h3>
                        </div>
                    </div>

                    <div class="section row">
                        <div class="col-md-6">
                            <button type="submit" class="button btn-success" id="login">Ya</button>
                        </div>
                        <div class="col-md-6">
                            <button type="submit" class="button btn-danger" id="login">Tidak</button>
                        </div>
                    </div>
                </form>
            </div>
                                        ...
                                        <tbody>
                                            @foreach ($nasabahs as $nasabah)
                                                <tr>
                                                    ...
                                                    @if ($nasabah->flag_status == 'Approve' || $nasabah->flag_status == 'Reject' || $nasabah->flag_proses == '1')
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="#"
                                                                style="color: #CE2222; text-decoration: none;pointer-events: none"
                                                                id="open-popup">Setor
                                                                Tunai</a>
                                                        </td>
                                                    @else
                                                        ...
                                                        <td>
                                                            <a href="#"
                                                                style="color: #CE2222; text-decoration: none;"
                                                                id="open-popup">Setor
                                                                Tunai</a>
                                                        </td>
                                                    @endif
    ...
    <!-- Page Plugins -->
    <script type="text/javascript" src="{!! asset('admindesigns/vendor/plugins/magnific/jquery.magnific-popup.js') !!}"></script>
