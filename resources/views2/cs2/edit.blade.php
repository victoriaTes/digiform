                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="POST" action="{{ route('edit.detail.post', ['id_nasabah' => $nasabah->id_nasabah]) }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="noKtp" name="noKtp" type="text" value="{{ $nasabah->nik }}" required autofocus >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="namaCust" class="col-lg-3 control-label">Nama Lengkap (Sesuai
                                            KTP)</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="namaCust" name="namaCust" type="text"
                                                value="{{ $nasabah->nama_lengkap }}" required autofocus >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="gelar"  name="gelar" type="text"
                                                value="{{ $nasabah->gelar }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="address1"  name="address1" type="text"
                                                value="{{ $nasabah->alamat_ktp }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="address2"  name="address2" type="text"
                                                value="{{ $nasabah->rtrw_ktp }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="address3"  name="address3" type="text"
                                                value="{{ $nasabah->kelurahan_ktp }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="address4"  name="address4" type="text"
                                                value="{{ $nasabah->kecamatan_ktp }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="address5"  name="address5" type="text"
                                                value="{{ $nasabah->kabupaten_ktp }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="propinsi" class="col-lg-3 control-label">Propinsi</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="propinsi"  name="propinsi" type="text"
                                                value="{{ $nasabah->propinsi_ktp }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="dom1" name="dom1" type="text"
                                                value="{{ $nasabah->alamat }}" required autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="dom2"  name="dom2" type="text"
                                                value="{{ $nasabah->rtrw }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="dom3"  name="dom3" type="text"
                                                value="{{ $nasabah->kelurahan }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="dom4"  name="dom4" type="text"
                                                value="{{ $nasabah->kecamatan }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="dom5"  name="dom5" type="text"
                                                value="{{ $nasabah->kabupaten }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="propdomi" class="col-lg-3 control-label">Propinsi</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="propdomi"  name="propdomi" type="text"
                                                value="{{ $nasabah->propinsi }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="agama"  name="agama" type="text"
                                                value="{{ $nasabah->agama }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="sex"  name="sex" type="text"
                                                value="{{ $nasabah->jenis_kelamin }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="negara"  name="negara" type="text"
                                                value="{{ $nasabah->negara }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="statusperkawinan" class="col-lg-3 control-label">Status
                                            Perkawinan</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="statusperkawinan"  name="statusperkawinan" type="text"
                                                value="{{ $nasabah->status_perkawinan }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="pendidikan"  name="pendidikan" type="text"
                                                value="{{ $nasabah->pendidikan }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="statusrumah" class="col-lg-3 control-label">Status Rumah</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="statusrumah"  name="statusrumah" type="text"
                                                value="{{ $nasabah->status_rumah }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="email"  name="email" type="text"
                                                value="{{ $nasabah->email }}" required autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="kelurahanperusahaan" name="kelurahanperusahaan"  type="text"
                                                value="{{ $nasabah->kelurahan_perusahaan }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="kecamatanperusahaan" class="col-lg-3 control-label">Kecamatan</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="kecamatanperusahaan"  name="kecamatanperusahaan" type="text"
                                                value="{{ $nasabah->kecamatan_perusahaan }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="kabupatenperusahaan" class="col-lg-3 control-label">Kabupaten</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="kabupatenperusahaan"  name="kabupatenperusahaan" type="text"
                                                value="{{ $nasabah->kabupaten_perusahaan }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="propinsiperusahaan" class="col-lg-3 control-label">Propinsi</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="propinsiperusahaan"  name="propinsiperusahaan" type="text"
                                                value="{{ $nasabah->propinsi_perusahaan }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="teleponperusahaan" class="col-lg-3 control-label">No. Telepon</label>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="jobPositionCode"  name="jobPositionCode" type="text"
                                                value="{{ $nasabah->pekerjaan }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="bidangusaha" class="col-lg-3 control-label">Bidang Usaha</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="bidangusaha"  name="bidangusaha" type="text"
                                                value="{{ $nasabah->bidang_usaha }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="jabatan"  name="jabatan" type="text"
                                                value="{{ $nasabah->jabatan }}" required autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="pembukanrekening" class="col-lg-3 control-label">Tujuan Pembukaan
                                            Rekening</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="pembukanrekening"  name="pembukanrekening" type="text"
                                                value="{{ $nasabah->tujuan_rek }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="sumberdana" class="col-lg-3 control-label">Sumber Dana</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="sumberdana"  name="sumberdana" type="text"
                                                value="{{ $nasabah->sumber_dana }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="pengguanaandana" class="col-lg-3 control-label">Tujuan Penggunaan
                                            Dana</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="pengguanaandana" name="pengguanaandana" type="text"
                                                value="{{ $nasabah->tujuan_dana }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="clearfix p15 ph15 text-center">
                                    ...
                                    {{-- <a class="btn mx-auto p8 w100" id="login"
                                            href="{{ route('konfirmasi.detail', ['id_nasabah' => $nasabah->id_nasabah]) }}">
                                            Edit</a> --}}
                                </form>
                            </div>
                        </div>
