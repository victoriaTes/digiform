                                ...
                                <form class="form-horizontal" role="form" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label for="disabledInput"
                                            class="col-lg-3 control-label mb20"><strong>Informasi
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->nama_lengkap }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->alamat_ktp }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->rtrw_ktp }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kelurahan_ktp }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kecamatan_ktp }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kabupaten_ktp }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->propinsi_ktp }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kode_pos_ktp }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->nomor_rumah }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">RT/RW</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kelurahan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Kecamatan</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kecamatan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Kabupaten</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kabupaten }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Propinsi</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->propinsi }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Kode Pos</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kode_pos }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->tempat_lahir }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->tgl_lahir }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->status_perkawinan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->pendidikan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->status_rumah }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->nama_ibu }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->nama_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->alamat_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->rt_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->rw_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Kelurahan</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kelurahan_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Kecamatan</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kecamatan_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Kabupaten</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kabupaten_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Propinsi</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->propinsi_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="disabledInput" class="col-lg-3 control-label">Kode Pos</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->kode_pos_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->telpon_perusahaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->pekerjaan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->bidang_usaha }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->jabatan }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->tujuan_rek }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->sumber_dana }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="disabledInput" type="text"
                                                value="{{ $nasabah->tujuan_dana }}" disabled>
                                        </div>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="disabledInput"
                                            class="col-lg-3 control-label mb20 mt20"><strong>Jenis
                                    ...
                                    <div class="clearfix p15 ph15 text-center">
                                        {{-- <a class="btn mx-auto p8 w100 mr20" id="login"
                                            href="{{ route('selfie') }}">
                                            Proses</a> --}}
                                        <button type="submit" class="btn mx-auto p8 w100"
                                            id="login">Proses</button>
