...
<body class="form-uploaders-page sb-l-c sb-l-m sb-r-c" data-target="#nav-spy" data-spy="scroll" data-offset="200">
        ...
        <section id="content_wrapper" class="mt50">
            ...
            <section id="content" class="p40" style="font-size: 15px;">
                ...
                <div class="section">
                    <div class="col-xs-12 col-sm-8 pl30  center-block">
                        <div class="tray-bin pl10 mb10" style="min-height: 250px;">
                            <h5 class="text-muted mt10 fw600 pl10"><i
                                    class="fa fa-exclamation-circle text-danger fa-lg pr10"></i> Unggah Foto Diri </h5>
                            <form class="dropzone dropzone-sm" id="dropZone" role="form" method="POST"
                                ...
                                @csrf
                                <input class="form-control" id="reg_id" name="reg_id" type="hidden"
                                    value="{{ $nasabah->reg_id }}">
                                <div class="fallback">
                ...
                <div class="clearfix p15 ph15 text-center">
                    <button type="submit" class="button mx-auto p8 w100" id="login">
                        Simpan</button>
                </div>
                <!-- end section -->
            </section>
    ...
    <script>
        // Nonaktifkan tombol "Simpan" secara awal
        document.getElementById('login').disabled = true;

        document.getElementById('login').addEventListener('click', function() {
            document.getElementById('dropZone').submit();
            window.location.href = "{{ route('kirim.detail', ['id_nasabah' => $nasabah->id_nasabah]) }}";
        });
    </script>
