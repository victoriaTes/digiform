                            ...
                            <div class="col-lg-8">
                                <select id="tabungan" name="tabungan" class="form-control" required>
                                    ...
                                    @if($nasabah ->jenis_tabungan)
                                        <option value="{{ $nasabah ->jenis_tabungan }}" selected>{{ $nasabah ->produk }}</option>
                                    @endif
                                    @foreach($produks as $produk)
                                        <option value="{{ $produk->kode }}">{{ $produk->produk }}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <select id="transfer" name="transfer" class="form-control" required>
                                    ...
                                    @if($nasabah ->transfer)
                                        <option value="{{ $nasabah ->transfer }}" selected>{{ $nasabah ->transfer }}</option>
                                    @endif
                                    <option>Tunai</option>
                                    <option>Debet Rekening</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <select id="kode_ao" name="kode_ao" class="form-control" required>
                                    ...
                                    @if($nasabah ->kode_ao)
                                        <option value="{{ $nasabah ->kode_ao }}" selected>{{ $nasabah ->kode_ao }}</option>
                                    @endif
                                    <option>GX</option>
                                    <option>YT</option>
                                </select>
