                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('datapekerjain') }}" role="form">
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <input type="text" id="propinsi" name="propinsi" class="form-control " placeholder="Provinsi" value="<?php echo $propinsi_ktp; ?>"  required />
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section">
                                        ...
                                        <input type="text" id="propdomi" name="propdomi" class="form-control " placeholder="Propinsi" value="<?php echo $propdomi; ?>"  />
                                    </div>
                                    <br/>
