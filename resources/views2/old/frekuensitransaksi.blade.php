                ...
                <div class="row">
                    ...
                    <div class="col-8 col-sm-9 col-md-7 col-lg-12 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <h1 style="color: #CE2222;">Frekuensi Transaksi</h1>
                                ...
                                <form class="form-horizontal" method="post" action="{{ route('viewdatanasabih') }}" role="form">
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="setorantunai" name="setorantunai" class="form-control form-control-lg required" required>
                                            <option value="<?php echo $setoran_tunai; ?>" selected><?php echo $setoran_tunai; ?></option>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="penukarantunai" name="penukarantunai" class="form-control form-control-lg required" required>
                                            <option value="<?php echo $penarikan_tunai; ?>" selected><?php echo $penarikan_tunai; ?></option>
                                            @foreach($PENDAPATA as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="setorannontunai" name="setorannontunai" class="form-control form-control-lg required" required>
                                            <option value="<?php echo $setoran_nontunai; ?>" selected><?php echo $setoran_nontunai; ?></option>
                                            @foreach($PENDAPATA as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="penarikannontunai" name="penarikannontunai" class="form-control form-control-lg required" required>
                                            <option value="<?php echo $penarikan_nontunai; ?>" selected><?php echo $penarikan_nontunai; ?></option>
                                            @foreach($PENDAPATA as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                        </select>
