                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <!-- <form class="dropzone dropzone-sm" id="dropZone" method="post" action="{{ route('datapekerjaan') }}" enctype="multipart/form-data" role="form"> -->
                                    <div class="section">
                                        <div class="col-xs-12 col-sm-8 pl30  center-block">
                                            <div class="tray-bin pl10 mb10" style="min-height: 250px;">
                                                ...
                                                <form action="{{ route('konfirmasi') }}" class="dropzone dropzone-sm" id="dropZone" enctype="multipart/form-data">
                                                    <div class="fallback">
                                    ...
                                    <div class="clearfix p15 ph15 text-center" >
                                        <a href="{{ route('konfirmasi') }}" style="display:none;" class="btn mx-auto p8 w100 mr20" id="login" >
                                            Lanjut</a>
