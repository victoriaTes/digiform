                    ...
                    <div class="col-8 col-sm-9 col-md-7 col-lg-12 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">                           
                            ...
                            <ul id="progressbar">
                                ...
                                <li id="personal"><strong>Informasi Data Utama</strong></li>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('msgkirimdata') }}" role="form">
                                    ...
                                    <div class="p25 br-b">
                                            ...
                                            <div class ="col-md-8" style="text-align: left;">
                                                <strong>{{ $data->kelurahan_ktp }}</strong>
                                            </div>
                                    ...
                                    <div class="p25 br-b">
                                            ...
                                            <div class ="col-md-8" style="text-align: left;">
                                                <strong>{{ $data->kecamatan_ktp }}</strong>
                                            </div>
                                    ...
                                    <div class="p25 br-b">
                                            ...
                                            <div class ="col-md-8" style="text-align: left;">
                                                <strong>{{ $data->kabupaten_ktp }}</strong>
                                            </div>
                                    ...
                                    <div class="p25 br-b">
                                            ...
                                            <div class ="col-md-8" style="text-align: left;">
                                                <strong>{{ $data->propinsi_ktp }}</strong>
                                            </div>
                                    ...
                                    <div class="p25 br-b">
                                            ...
                                            <div class ="col-md-8" style="text-align: left;">
                                                <strong>{{ $data->kode_pos_ktp }}</strong>
                                            </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->nomor_rumah }}</strong>
                                        </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->status_perkawinan }}</strong>
                                        </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->status_rumah }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->alamat_perusahaan }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->rt_perusahaan }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->rw_perusahaan }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->kabupaten_perusahaan }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->kecamatan_perusahaan }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->propinsi_perusahaan }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->kode_pos_perusahaan }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->telpon_perusahaan }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->bidang_usaha }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->sumber_dana }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p25 br-b">
                                        ...
                                        <div class ="col-md-8" style="text-align: left;">
                                            <strong>{{ $data->tujuan_dana }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="clearfix p15 ph15 text-center">
                                        <a href="{{ route('datakeuangan') }}" class="btn mx-auto p8 w100 mr20" id="login" style="display:none;" >
                                            Kembali</a>
                                        <button class="btn mx-auto p8 w100" type="submit" id="login">Kirim</button>
