                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('editkonfirmasi') }}" role="form">
                                    @csrf
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="gelar" name="gelar" class="form-control required" required>
                                            <option value="<?php echo $gelar; ?>" selected><?php echo $gelar; ?></option>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <input type="text" id="kodepos" name="kodepos" class="form-control " placeholder="Kode Pos" value="<?php echo $kodepos; ?>" required  />
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <input type="text" id="dom1" name="dom1" class="form-control " placeholder="Alamat Saat Ini" value="<?php echo $dom1; ?>"  />
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section">
                                        ...
                                        <input type="text" id="dom2" name="dom2" class="form-control " placeholder="RT/RW" value="<?php echo $dom2; ?>"  />
                                    </div>
                                    <br/>

                                    <div class="section">
                                        <label for="propdomi"style="color: black;"><strong>Propinsi :</strong></label>
                                        <input type="text" id="propdomi" name="propdomi" class="form-control " placeholder="Propinsi" style="display:none;" value="<?php echo $propdomi; ?>"  />
                                    ...
                                    <div class="section">
                                        ...
                                        <input type="text" id="dom3" name="dom3" class="form-control " placeholder="Kelurahan" value="<?php echo $dom3; ?>"  />
                                    </div>
                                    <br/>

                                    <div class="section mb-3">
                                        <label for="dom4"style="color: black;"><strong>Kecamatan :</strong></label>
                                        <input type="text" id="dom4" name="dom4" class="form-control " placeholder="Kecamatan" value="<?php echo $dom4; ?>"  />
                                    </div>
                                    <br/>

                                    <div class="section">
                                        <label for="dom5"style="color: black;"><strong>Kabupaten :</strong></label>
                                        <input type="text" id="dom5" name="dom5" class="form-control " placeholder="Kabupaten" value="<?php echo $dom5; ?>"  />
                                    </div>
                                    <br/>

                                    <div class="section">
                                        <label for="kodeposdomi"style="color: black;"><strong>Kode Pos :</strong></label>
                                        <input type="text" id="kodeposdomi" name="kodeposdomi" class="form-control " placeholder="Kode Pos" value="<?php echo $kodeposdomi; ?>"  />
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section">                                     
                                        ...
                                        <input type="text" id="nohp" name="nohp" class="form-control" placeholder="No.HP" value="<?php echo $nohp; ?>" required>          
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section">
                                        ...
                                        <select id="statusperkawinan" name="statusperkawinan" class="form-control " required>
                                            <option value="<?php echo $status_perkawinan; ?>" selected><?php echo $status_perkawinan; ?></option>
                                    ...
                                    <div class="section">
                                        ...
                                        <input type="text" id="hobby" name="hobby" class="form-control" placeholder="" value="{{ $hobby }}" required />
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section">
                                        ...
                                        <select id="statusrumah" name="statusrumah" class="form-control required" required>
                                            <option value="<?php echo $statusrumah; ?>" selected><?php echo $statusrumah; ?></option>
                                    ...
                                    <div class="clearfix p15 ph15 text-center">
                                        <!-- <a href="{{ route('datapekerjaan') }}" class="btn mx-auto p8 w100 mr20" id="login"  >
                                            Kembali</a> -->
                                        <button class="btn btn-primary btn-lg ml10" type="submit" style="display:none;" name="login" value="Kembali" id="btnlogin">Kembali</button>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
