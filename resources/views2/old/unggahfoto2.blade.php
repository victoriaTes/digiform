                    ...
                    <div class="col-md-12" >
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="post" action="{{ route('konfirmasa') }}" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="section mb-6" >
                                        ...
                                        <!-- <img class="img-fluid" id="gambar" src="#" alt="Pilih Gambar"  style="display:none;" OnError=" $(this).hide();"/> -->
                                    </div>

                                    <div class="p25 br-b">
                                        <img class="img-fluid" id="gambar" src="#" alt="Pilih Gambar" width="750px"  style="display:none;" OnError=" $(this).hide();"/>
                                    </div>

                                    <div class="section mb-6" >
                                         <img class="responsive" id="gambar" src="#" alt="Pilih Gambar" width="550px"  style="display:none;" OnError=" $(this).hide();"/>
                                    </div>
