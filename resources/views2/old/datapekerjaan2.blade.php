                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('datakeuangin') }}" role="form">
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <input type="text" id="namaperusahaan" name="namaperusahaan" class="form-control required" value="" placeholder="Nama Perusahaan"  />
                                    </div>
                                    <br/>
                                    @csrf
                                    <div class="section mb-3">
                                        <label for="alamatPerusahaan"style="color: black;"><strong>Alamat Perusahaan</strong></label>    
                                        <input type="text" id="alamatPerusahaan" name="alamatPerusahaan" class="form-control required" value="" placeholder="Alamat Perusahaan" />                   
                                    </div>
                                    <br/>

                                    <div class="section mb-3">
                                        <label for="rtperusahaan"style="color: black;"><strong>RT :</strong></label>    
                                        <input type="text" id="rtperusahaan" name="rtperusahaan" class="form-control required" value="" placeholder="RT" />                   
                                    </div>
                                    <br/>

                                    <div class="section mb-3">
                                        <label for="rwperusahaan"style="color: black;"><strong>RW :</strong></label>    
                                        <input type="text" id="rwperusahaan" name="rwperusahaan" class="form-control required" value="" placeholder="RW" />                   
                                    </div>
                                    <br/>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <input type="text" id="kodeposperusahaan" name="kodeposperusahaan" class="form-control required" value="" placeholder="Kode Pos" required />                   
                                    </div>
                                    <br/>

                                    <div class="section">
                                        <label for="teleponperusahaan"style="color: black;"><strong>No.Telepon :</strong></label>
                                        <input type="tel" name="teleponperusahaan" id="teleponperusahaan" class="form-control required" placeholder="Telepon" required />
