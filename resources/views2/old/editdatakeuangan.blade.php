                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('editestimasiperkiraan') }}" role="form">
                                    @csrf
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="penghasilantambahan" name="penghasilantambahan" class="form-control form-control-lg required">
