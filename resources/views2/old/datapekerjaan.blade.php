                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('datakeuangin') }}" role="form">
                                    ...
                                    <div class="section">
                                        ...
                                        <table>
                                            <tr>
                                                <td><input type="text" name="teleponareaperusahaan" size="50" id="teleponareaperusahaan" class="form-control required" value="<?php echo $artlpprs; ?>" placeholder="Telepon" required /></td>
                                                <td>&nbsp;&nbsp;</td>
                                                <td><input type="text" name="teleponperusahaan" id="teleponperusahaan" class="form-control required" size="200" value="<?php echo $telpon_perusahaan; ?>" placeholder="Telepon" required /></td>
                                            <tr>
                                        </table>
                                        <!-- <br/>
                                        <div class="col-md-2" >
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <!-- <option value="<//?php echo $kdoccupation; ?>"><//?php echo $occupation; ?></option> -->
                                            ...
                                            @foreach($BIDANGPEKERJAA as $BIDANGPEKERJA)
                                                <option value="{{$BIDANGPEKERJA->keterangan}}" >{{$BIDANGPEKERJA->keterangan}}</option>
                                            @endforeach
                                        <!-- <.?php } ?> -->
