            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST"
                        action="{{ route('kirim.detail.post', ['id_nasabah' => $nasabah->id_nasabah]) }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <img src="{{ asset('storage/foto/' . $nasabah->ktp) }}" alt="avatar"
                                    id="disabledInput">
                            </div>
                        </div>
