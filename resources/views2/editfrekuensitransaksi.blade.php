                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('viewdatanasabih') }}" role="form">
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="setorantunai" name="setorantunai" class="form-control form-control-lg required">
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="penukarantunai" name="penukarantunai" class="form-control form-control-lg required">
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="setorannontunai" name="setorannontunai" class="form-control form-control-lg required">
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="penarikannontunai" name="penarikannontunai" class="form-control form-control-lg required">
