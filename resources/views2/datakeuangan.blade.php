                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{ route('estimasiperkirain') }}" role="form">
                                    ...
                                    <div class="section mb-3">
                                        <label for="penghasilan"style="color: black;"><strong>Jika Karyawan Penghasilan Utama (Kotor Per-Bulan dalam Rupiah) :</strong></label>
                                        <select id="penghasilan" name="penghasilan" class="form-control form-control-lg required" required>
                                            <option value="<?php echo $penghasilan; ?>" selected><?php echo $penghasilan; ?></option>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <option value="<?php echo $tujuan_rek; ?>" selected><?php echo $tujuan_rek; ?></option>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="sumberdana" name="sumberdana" class="form-control form-control-lg required" required>
                                            <option value="<?php echo $sumber_dana; ?>" selected><?php echo $sumber_dana; ?></option>
                                    ...
                                    <div class="section mb-3">
                                        ...
                                        <select id="pengguanaandana" name="pengguanaandana" class="form-control form-control-lg required" required>
                                            <option value="<?php echo $tujuan_dana; ?>" selected><?php echo $tujuan_dana; ?></option>
                                            @foreach($SUMBERDAN as $dt)
                                                <option value="{{$dt->keterangan}}" >{{$dt->keterangan}}</option>
                                            @endforeach
                                        </select>
