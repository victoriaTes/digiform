                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST"
                        ...
                        <div class="form-group mt30">
                            ...
                            <div class="col-lg-8">
                                <input id="aml" name="aml" value="1" class="form-check-input" type="checkbox"
                                    onchange="updateCheckbox('aml')" {{ $nasabah->aml == '1' ? 'checked' : '' }} disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input id="edd" name="edd" value="1" class="form-check-input" type="checkbox"
                                    onchange="updateCheckbox('edd')" {{ $nasabah->edd == '1' ? 'checked' : '' }} disabled>
                                <b>Enhanced Due Diligence (Optional)</b>
                            </div>
                        </div>
                        ...
                        @if ($nasabah->flag_status == '0')
                            <div class="clearfix p15 ph15 text-center mt50">
                                <button type="submit" class="btn btn-success btn-lg mx-auto p8 w100 mr20" name="action"
                                    value="approve" onclick="confirmSubmit(event)"> Approve
                                </button>
