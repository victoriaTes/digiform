            ...
            <td>
                <div class="col-md-12">
                    <table width="100%">
                        ...
                        <tr>
                            <td height="20" align="center" bgcolor= "grey"  style="font-size:10px;color:white;border-top: 0.5pt solid black;border-bottom: 0.5pt solid black;border-left: 0.5pt solid black;border-right: 0.5pt solid black;"><b>INFORMASI DATA UTAMA</b></td>
                        </tr>
                    </table>
                    <table width="100%">
                        <tr>
                ...
                <div class="col-md-12 mt10">
                    <table width="100%">
                        <tr>
                        <td height="20" align="center" bgcolor= "grey"  style="font-size:10px;color:white;border-top: 0.5pt solid black;border-bottom: 0.5pt solid black;border-left: 0.5pt solid black;border-right: 0.5pt solid black;"><b>DATA PEKERJAAN</b></td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12 mt10">
                    <table width="100%">
                        <tr>
                        <td height="20" align="center" bgcolor= "grey"  style="font-size:10px;color:white;border-top: 0.5pt solid black;border-bottom: 0.5pt solid black;border-left: 0.5pt solid black;border-right: 0.5pt solid black;"><b>DATA KEUANGAN</b></td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12 mt10">
                    <table width="100%">
                        <tr>
                        <td height="20" align="center" bgcolor= "grey"  style="font-size:10px;color:white;border-top: 0.5pt solid black;border-bottom: 0.5pt solid black;border-left: 0.5pt solid black;border-right: 0.5pt solid black;"><b>DATA DIISI OLEH BANK</b></td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-12">
