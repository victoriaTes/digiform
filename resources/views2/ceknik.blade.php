                ...
                <div class="row">
                    ...
                    <div class="col-8 col-sm-9 col-md-7 col-lg-12 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <h1 style="color: #CE2222;">MASUKAN NIK KTP</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12" >
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="post" action="{{ route('ktpnikcek') }}" role="form" >
                                 
                                    @csrf
                                    <div class="col-md-4" >
                                    </div>
                                    <div class="section mb-6 col-md-4" >
                                         <h2 class="text-muted mt10 fw600 pl10"> NIK </h2>
                                        <input name="nik" id='nik' type="text" class="form-control" minlength="16" maxlength="16" autocomplete="off" pattern="[0-9]{16}" title="Harus terdiri dari 16 angka" required />
                                    ...
                                    <!-- <div class="clearfix p15 ph15 text-center" > -->
                                        <!-- <a href="" style="display:none;" class="btn mx-auto p8 w100 mr20" id="login" >
                                            Lanjut</a> -->
                                            <h2 class="text-muted mt10 fw600 pl10">&nbsp; </h2>
                                        <input type="submit"class="btn mx-auto p8 w100" id="login" value="Search">
                                    <!-- </div> -->
                                    </div>
