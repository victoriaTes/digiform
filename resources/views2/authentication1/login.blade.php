                    ...
                    <div class="panel panel-info mt10 br-n mw800 ">
                        ...
                        <form id="contact">
                                    ...
                                    <div class="col">
                                        <div class="section">
                                            ...
                                            <label for="username" class="field prepend-icon">
                                                <input type="text" name="username" id="username" class="gui-input" placeholder="Enter username" required autofocus>
                                                <label for="username" class="field-icon"><i class="fa fa-user"></i>
                                                </label>
                                            </label>
                                        </div>
                                        <div class="section">
                                            <label for="username" class="field-label text-muted fs18 mb10 mt30">Password</label>
                                            <label for="password" class="field prepend-icon">
                                                <input type="password" name="password" id="password" class="gui-input" placeholder="Enter password" required autofocus>
                            ...
                            <div class="clearfix p20 ph15 text-center bg-light">
                                <button type="submit" class="button mx-auto" id="login">Login</button>
                            </div>
                        </form>
                    </div>
            ...
            if (contactForm) {
                contactForm.addEventListener("submit", function(e) {
                    ...
                    if (username === 'cs' && password === 'cs') {
                        // Redirect to the '/dashboardcs' route
                        window.location.href = '/cs/menu';
                    } else if (username === 'kaops' && password === 'kaops') {
                        // Redirect to the '/dashboardcs' route
                        window.location.href = '/kaops/menu';
                    }else {
                        // Add your logic for invalid credentials (optional)
