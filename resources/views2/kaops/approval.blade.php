            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST"
                        ...
                        <div class="form-group" style="display: none">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" id="tabungan" name="tabungan" type="text"
                                    value="{{ $nasabah->jenis_tabungan }}" disabled>
                            </div>
                        </div>
                        ...
                        {{-- <button type="submit" class="btn mx-auto p8 w130" id="login">CORE</button> --}}
                        ...
                        @if ($nasabah->flag_status == '0')
                            <div class="clearfix p15 ph15 text-center mt50">
                                <button type="submit" class="btn btn-success btn-lg mx-auto p8 w100 mr20" name="action"
                                    value="approve" id="login"
                                    style="background-color: rgb(12, 193, 12); border-color: rgb(12, 193, 12);"
                                    onclick="confirmSubmit(event)"> Approve
                                </button>
                                {{-- <button type="submit" id="login" class="btn btn-danger btn-lg mx-auto p8 w100 mr20" name="action"
                                    value="reject" onclick="confirmSubmit(event)"> Tolak
                                </button> --}}
                                {{-- <button type="button" class="btn btn-danger btn-lg mx-auto p8 w100 mr20"
                                    data-toggle="modal" id="login" data-target="#rejectModal">Tolak</button> --}}
                                {{-- <button type="submit" class="btn btn-info btn-lg mx-auto p8 w100 mr20" name="action"
                                    value="edit" onclick="confirmSubmit(event)"> Reject
                                </button> --}}

                                <button type="button" class="btn btn-danger btn-lg mx-auto p8 w100 mr20" data-toggle="modal" id="login" data-target="#rejectModal">Tolak</button>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-danger" name="action" id="submitReject" value="reject">Tolak</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
