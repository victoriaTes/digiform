...
class BerandaController extends Controller
{
    ...
    public function datapekerjain(Request $request)
    {
        ...
        if($btnkrmdata=="Kembali"){
            ...
            return view('datapekerjaan',$array,compact('prop','PEKERJAA','BIDANGPEKERJAA','JABATA'));
        }
    }
    ...
    public function datakeuangin(Request $request)
    {
        ...
        if($btnkrmdata=="Kembali"){
            ...
            $isidata = $nomornik."|".$namaperusahaan."|".$alamatPerusahaan."|".$rtperusahaan."|".$rwperusahaan."|".$kelurahanperusahaan."|".$kecamatanperusahaan."|".$kabupatenperusahaan."|".$propinsiperusahaan
                        ."|".$kodeposperusahaan."|".$teleponperusahaan."|".$jobPositionCode."|".$bidangusaha."|".$jabatan."|".$teleponareaperusahaan;  
            ...
            return view('datakeuangan',$array,compact('SUMBERPENGHASILA','SUMBERDAN'));
        }
    }
    ...
    public function msgkirimdata(Request $request)
    {
        ...
        if($btnkrmdata=="Kembali"){
            ...
            return view('frekuensitransaksi',$array,compact('PENDAPATA'));
        }else{
            $datax = DB::select('CALL sp_insert_nasabah(?,?)', ['9', $nomornik]);
            ...
            $client = new Client();
            $responses = $client->request('POST', 'http://vicrun.victoriabank.co.id/api/cekAML', [
                'form_params' => [
