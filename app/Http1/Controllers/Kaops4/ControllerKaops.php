...
class ControllerKaops
{
    ...
    public function core(Request $request, $id_nasabah)
    {
        $id_nasabah = $request->input('id_nasabah');
        $client = new Client();
        $apiUrl = 'http://172.21.20.88/api/kycCif';
        ...
        $jsonBody = [
            ...
            'empAddress2' => $request->input('kecamatanperusahaan') . ', ' . $request->input('propinsiperusahaan'),
            ...
            'jumAnak' => "0" . $request->input('punya_anak'),
            'jumIstri' => "0" . $request->input('punya_istri'),
            'jumTanggung' => $jumAnak,
