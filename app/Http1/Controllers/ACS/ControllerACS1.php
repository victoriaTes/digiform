...
class ControllerACS
{
    ...
    public function newrole(Request $request)
    {
        ...
        $isidata = $role . "|" . $kode_role . "|" . $verifikasi . "|" . $approve . "|" . $account . "|" . $flag_status . "|" . $role_user . "|" . $jabatan_user;
    ...
    public function update_role(Request $request, $id)
    {
        ...
        $isidata = $id . "|" . $role . "|" . $kode_role . "|" . $verifikasi . "|" . $approve . "|" . $account . "|" . $role_user . "|" . $jabatan_user;
